...
mod tests {
    ...
    fn not_nailed_norwegian_blue_parrot_with_high_voltage() {
        let parrot = NorwegianParrot { voltage: 4.0,
                              nailed: false };
